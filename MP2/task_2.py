...
def run_pytest_and_get_coverage(task_id, prompt_type):
    ...
    id  = task_id.split('/')[1]
    pytest_command = [
        'pytest', '--cov-config', '.coveragerc', f'Coverage/{prompt_type}/HumanEval/{id}/{id}_test.py', '--cov', f'Coverage/{prompt_type}/HumanEval/{id}', '--cov-report', f'json:Coverage/{prompt_type}/HumanEval/{id}/{id}_report.json'
    ]
    ...
    coverage_report_path = f'Coverage/{prompt_type}/HumanEval/{id}/{id}_report.json'
    ...
    total_coverage = coverage_data.get('totals', {}).get('percent_covered_display', None)

    if total_coverage is not None:
        print(f"Total Coverage: {total_coverage}%")
        return total_coverage
    else:
        print("Could not find coverage information in the report.")
        return total_coverage
